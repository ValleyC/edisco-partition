"""
Attention Model (Reviser) from GLOP for solving SHPP (Shortest Hamiltonian Path Problem).

This is the pretrained TSP solver that improves sub-routes during partition training.
"""
